...
class UpdateMemberTest {
	...
	private static final String MEMBERDAO_PATH = "memberDAO.selectMemberById(memberVO.getId()).";
	...
	void testUpdateMemberByPw() {
		...
		String strUpdatePw = MEMBERDAO_PATH + "getPw()";
	...
	void testUpdateMemberByEmail() {
		...
		String strUpdateEmail = MEMBERDAO_PATH + "getEmail()";
	...
	void testUpdateMemberByPhone() {
		...
		String strUpdatePhone = MEMBERDAO_PATH + "getPhone()";
